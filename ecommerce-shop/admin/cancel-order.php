...
$select_query = "SELECT * FROM orders WHERE order_status = 'Canceled'";
                        ...
                        <td>
                          ...
                          <?php
                            if($order_info['user_pay_status'] == 0){
                              ...
                              echo '<a class="badge badge-danger p-2 mt-2">upaid</a>
                          </td>
                            ';
                          }
                          else{

                          echo '<a class="badge badge-success p-2 mt-2">paid</a>
                          </td>
                              ';
                            }
                          ?>
                        <td>
                            <?php
                              if($order_info['order_status'] === "Pending"){
                                echo '<a class="badge badge-danger p-2 mt-2"> Pending </a>';
                                  
                              }
                              elseif($order_info['order_status'] === "On delivery")
                                {
                                echo '<a class="badge badge-warning text-white p-2 mt-2"> On delivery </a>';
                                  
                              }
                              elseif($order_info['order_status'] === "Delivered")
                                {
                                echo '<a class="badge badge-success p-2 mt-2"> Delivered </a>';
