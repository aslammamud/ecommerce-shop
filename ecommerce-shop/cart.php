<?php
$page='single';
$page_title = 'Shopping Cart | Stylishvalley.com';
              ...
              <div class="table-responsive">
                <table class="table table-bordered cart_summary">
                        ...
                        $('#cart_all_delete').click(function(){
                          ...
                          Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                if(window.location.href = "cart_action?clear=all"){
                                  Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                  ...
                  <tbody>
                    ...
                    $product_s = "SELECT * FROM products WHERE product_code = '$code'"; 
                    ...
                    <input type="hidden" class="pprice" value="<?= $row['product_price'] ?>">
                      <td class="text-left cart_product"><a href="#"><img src="admin/images/product_image/<?= $row['product_image'] ?>" alt="Product"></a></td>
                      <td class="text-left cart_description"><p class="product-name"><a href="#"><?= $row['product_name'] ?></a></p>
                    ...
                    ?>
                      <td class="price"><span><?= number_format($row['product_price'],2); ?>  ৳ </span></td>
                      
                      <td class="qty">
                          <input type="number" class="form-control itemQty" value="<?= $row['qty'] ?>" style="width:75px;">
                        </td>
                      <td class="price"><span><?= number_format($row['total_price'],2); ?>  ৳ </span></td>
                      <td class="action">
