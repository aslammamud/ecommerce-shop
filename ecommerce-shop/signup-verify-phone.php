...
sendSMS('8809612737373',$phone,'Welcome to Stylish Valley! '.$code.' is your OTP Verification code.');
}
...
<center class="custom-css">
<div class="texth mt-4">Phone varification code</div>
...
<center>
		<form action="<?php echo htmlspecialchars("signup-verify-otp-set-account.php"); ?>"  method="POST" class="login100-form validate-form p-t-45">
